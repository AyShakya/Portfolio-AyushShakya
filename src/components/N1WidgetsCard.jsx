      ...
      <div className="flex w-full justify-center gap-6 md:gap-10">
        ...
        <div className="relative w-28 h-28 md:w-32 md:h-32 rounded-full bg-[#121212] flex items-center justify-center border border-neutral-800/40">
          ...
          <div className="relative w-20 h-20">
            {/* Hour hand */}
            <div 
              className="absolute top-10 left-10 w-1.5 h-6 bg-white origin-bottom rounded-full -translate-x-[3px] -translate-y-6"
            ...
            ></div>
            {/* Center Pin */}
            <div className="absolute top-10 left-10 w-2.5 h-2.5 rounded-full bg-white border border-neutral-800 -translate-x-[5px] -translate-y-[5px]"></div>
          </div>
        </div>
      </div>

      {/* Weather Widget */}
      <div className="w-full rounded-2xl bg-[#121212] p-5 md:p-6 flex flex-col justify-between border border-neutral-800/40 text-white">
        {/* Top Info */}
